    ...
    overdue: {
      true: {
        ...
        "&::before": {
          ...
          background: "linear-gradient(110deg, var(--overdue-glow-warm) 0%, var(--overdue-glow-hot) 28%, var(--overdue-glow-critical) 52%, var(--overdue-glow-pulse) 73%, var(--overdue-glow-warm) 100%)",
          backgroundSize: "220% 100%",
          content: "",
          filter: "blur(0.9rem) saturate(1.15)",
          opacity: 0.8,
          pointerEvents: "none",
        ...
        "&::after": {
          ...
          backgroundSize: "220% 100%",
          content: "",
          filter: "blur(0.25rem) saturate(1.2)",
          opacity: 0.82,
          pointerEvents: "none",
